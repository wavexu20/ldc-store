...
const tierVisuals: Record<MembershipTier["key"], { icon: typeof Medal; card: string; iconWrap: string; progress: string; detail: string }> = {
  starter: { icon: Medal, card: "border border-slate-200 bg-[linear-gradient(135deg,#ffffff_0%,#f8fafc_52%,#e2e8f0_100%)] text-slate-900 dark:border-slate-700 dark:bg-[linear-gradient(135deg,#27272a_0%,#18181b_52%,#3f3f46_100%)] dark:text-white", iconWrap: "bg-white/75 text-slate-700 shadow-sm dark:bg-white/10 dark:text-white", progress: "bg-slate-700 dark:bg-slate-200", detail: "text-slate-600 dark:text-slate-300" },
  silver: { icon: Medal, card: "border border-slate-300 bg-[linear-gradient(135deg,#f8fafc_0%,#cbd5e1_52%,#f8fafc_100%)] text-slate-900 dark:border-slate-600 dark:bg-[linear-gradient(135deg,#334155_0%,#64748b_52%,#334155_100%)] dark:text-white", iconWrap: "bg-white/55 text-slate-700 shadow-sm dark:bg-white/10 dark:text-white", progress: "bg-slate-600 dark:bg-slate-100", detail: "text-slate-600 dark:text-slate-200" },
  gold: { icon: Crown, card: "border border-amber-300 bg-[linear-gradient(135deg,#fffbeb_0%,#fcd34d_52%,#fef3c7_100%)] text-amber-950 dark:border-amber-700 dark:bg-[linear-gradient(135deg,#78350f_0%,#b45309_52%,#78350f_100%)] dark:text-amber-50", iconWrap: "bg-white/45 text-amber-800 shadow-sm dark:bg-white/10 dark:text-amber-50", progress: "bg-amber-700 dark:bg-amber-200", detail: "text-amber-900/75 dark:text-amber-100/80" },
  obsidian: { icon: Crown, card: "border border-zinc-700 bg-[radial-gradient(circle_at_88%_12%,#3f3f46_0%,#18181b_38%,#09090b_100%)] text-white", iconWrap: "bg-white/10 text-white ring-1 ring-white/20", progress: "bg-white", detail: "text-zinc-300" },
};
...
export function WalletView({ data }: { data: WalletData }) {
  ...
  return <div className="mx-auto max-w-5xl space-y-6 px-4 py-8 sm:py-10">
    ...
    <div className="grid gap-3 sm:grid-cols-2"><div className="flex gap-3 rounded-xl border bg-card p-4"><div className="rounded-lg bg-warning/10 p-2 text-warning"><Gift className="size-5" /></div><div><p className="font-medium">充值赠送</p><p className="mt-1 text-sm text-muted-foreground">每次充值额外获得 1% 奖励金。</p></div></div><div className="flex gap-3 rounded-xl border bg-card p-4"><div className="rounded-lg bg-brand/10 p-2 text-brand"><Sparkles className="size-5" /></div><div><p className="font-medium">积分抵扣</p><p className="mt-1 text-sm text-muted-foreground">实付 ¥1 获得 1 积分；200 积分抵 ¥1，单笔最高抵 10%。</p></div></div></div>

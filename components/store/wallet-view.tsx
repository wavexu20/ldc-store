...
const tierVisuals: Record<MembershipTier["key"], { card: string; iconWrap: string; progress: string; detail: string }> = {
  starter: { card: "border border-stone-600 bg-[radial-gradient(circle_at_85%_8%,#665142_0%,#332b25_36%,#171411_100%)] text-stone-50", iconWrap: "bg-black/20 ring-1 ring-[#d6a06a]/45", progress: "bg-[#d6a06a]", detail: "text-stone-300" },
  silver: { card: "border border-slate-300 bg-[linear-gradient(135deg,#f8fafc_0%,#cbd5e1_52%,#f8fafc_100%)] text-slate-900 dark:border-slate-600 dark:bg-[linear-gradient(135deg,#334155_0%,#64748b_52%,#334155_100%)] dark:text-white", iconWrap: "bg-white/55 shadow-sm dark:bg-white/10", progress: "bg-slate-600 dark:bg-slate-100", detail: "text-slate-600 dark:text-slate-200" },
  gold: { card: "border border-amber-300 bg-[linear-gradient(135deg,#fffbeb_0%,#fcd34d_52%,#fef3c7_100%)] text-amber-950 dark:border-amber-700 dark:bg-[linear-gradient(135deg,#78350f_0%,#b45309_52%,#78350f_100%)] dark:text-amber-50", iconWrap: "bg-white/45 shadow-sm dark:bg-white/10", progress: "bg-amber-700 dark:bg-amber-200", detail: "text-amber-900/75 dark:text-amber-100/80" },
  obsidian: { card: "border border-zinc-700 bg-[radial-gradient(circle_at_88%_12%,#3f3f46_0%,#18181b_38%,#09090b_100%)] text-white", iconWrap: "bg-white/10 ring-1 ring-white/20", progress: "bg-white", detail: "text-zinc-300" },
};
